# -*- coding: utf-8 -*-
"""
Created on Fri Aug  6 02:18:50 2021
...
def lab04_task1_2019_1_60_024():
 print ('Number of rows: ', df.shape[0])
 print ('Number of columns: ', df.shape[1])
 
#%%
#task 1
lab04_task1_2019_1_60_024()
...
def lab04_task2_2019_1_60_024():
 print(df[['Time', 'Amount']].describe())
 #print("description: \n\n",df.describe())
#%%
lab04_task2_2019_1_60_024()
#%%
# Student ID: 2019-1-60-024
# Student Name: Adri Saha
...
def lab04_task10_2019_1_60_024():
    correlation= df.corr()
    #print(correlation)
    ...
    print(result1)
#%%
lab04_task10_2019_1_60_024()
#%%
'''correlation_pos= df.corr()
positive_corr= correlation_pos.max()
...
def lab04_task11_2019_1_60_024():
...
def lab04_task12_2019_1_60_024():
    correlation= df.corr()
    #print(correlation)
...
def lab04_task14_2019_1_60_024():
     df.boxplot(column = ['Amount'])
     
#%%
lab04_task14_2019_1_60_024()
#%%
# Student ID: 2019-1-60-024
# Student Name: Adri Saha
...
def lab04_task15_2019_1_60_024():
    import matplotlib.pyplot as plt
    import assignModule as am
